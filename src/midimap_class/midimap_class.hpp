 ...
 */
 class midimap_ : public MIDI_Sender<midimap_>,
 public TrueMIDI_SinkSource {

friend class MIDI_Sender<midimap_>;
...
midimap_(midimap_ const &) = delete;
/// Copying is not allowed
midimap_ &operator=(midimap_ const &) = delete;

/// Return the static midimap_ instance (midimap_ is a
/// singleton.)
static midimap_ &getInstance();

private:
/// midimap_ is a singleton, so the constructor is private.
midimap_() = default;
...
#define midimap (midimap_::getInstance())
#endif
