...
#include <MIDI_Senders/NoteVelPotentiometerSender.hpp>
 ...
 */
class NoteVelPotentiometer : public MIDIFilteredAnalog<NoteVelPotentiometerSender> {
  public:
    /** 
    ...
    NoteVelPotentiometer(pin_t analogPin, MIDIAddress address, 
        ...
        : MIDIFilteredAnalog(analogPin, address, 
                            NoteVelPotentiometerSender(MinNoteThreshold,
    ...
    NoteVelPotentiometer(pin_t analogPin, MIDIAddress address, 
        ...
        : MIDIFilteredAnalog(analogPin, address, 
                            NoteVelPotentiometerSender(MinNoteThreshold, minPhysicalVelocity, maxPhysicalVelocity,
