...
#include <MIDI_Senders/PCPotentiometerSender.hpp>
 ...
 */
class PCPotentiometer : public MIDIFilteredAnalog<PCPotentiometerSender> {
  public:
    /**
    ...
    PCPotentiometer(pin_t pin, MIDIAddress address, uint8_t triggerValue)
        : MIDIFilteredAnalog(pin, address, PCPotentiometerSender(triggerValue)) {}
    ...
    PCPotentiometer(pin_t pin, MIDIAddress address, uint8_t triggerValue, 
        ...
        : MIDIFilteredAnalog(pin, address, 
                    PCPotentiometerSender(triggerValue, MinThreshold, MaxThreshold)) {}
};
